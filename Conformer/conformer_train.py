...
from conformer_model import ConformerTransformerModel
...
def train_one_epoch(
    ...
    for batch_idx in range(1, steps + 1):
        ...
        if batch_idx == 1 or batch_idx % log_interval == 0 or batch_idx == steps:
            print(
                f"[Train] "
...
def train():
    ...
    parser.add_argument("--ffn_expansion_factor", type=int, default=4)

    parser.add_argument("--save_model", type=str, default="conformer_lm_best.pt")
    parser.add_argument("--save_fig", type=str, default="conformer_lm_history.png")
    ...
    model = ConformerTransformerModel(
